...
public class SMPPServer extends ServerResponseDeliveryAdapter implements Runnable, ServerMessageReceiverListener {
    ...
    public SMPPServer(boolean useSsl, int port, String systemId, String password) {
        this.useSsl = useSsl;
        this.port = port;
    ...
    public SubmitSmResult onAcceptSubmitSm(SubmitSm submitSm, SMPPServerSession source) {
        ...
        log.info("Server: Receiving submit_sm '{}', and return message id {}", message, messageId);
    ...
    public static void main(String[] args) {
        ...
        SMPPServer smppServerSim = new SMPPServer(useSsl, port, systemId, password);
        smppServerSim.run();
    }
}