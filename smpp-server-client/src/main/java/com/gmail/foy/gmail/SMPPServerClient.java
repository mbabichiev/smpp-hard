...
import com.gmail.foy.gmail.services.MessageService;
...
public class SMPPServerClient extends ServerResponseDeliveryAdapter implements Runnable, ServerMessageReceiverListener {

    private static final Logger log = LoggerFactory.getLogger(SMPPServerClient.class);
    ...
    public SMPPServerClient(boolean useSsl, int port, String systemId, String password) {
        this.useSsl = useSsl;
        this.port = port;
    ...
    public static void main(String[] args) {
        ...
        SMPPServerClient smppServerSim = new SMPPServerClient(useSsl, port, systemId, password);
        smppServerSim.run();
    }
}